...
sh $dirname/scripts/prepare-directories-server.sh $dirname
echo "==========================================================================================================="
...
source $dirname/scripts/generate-key-system-server.sh $dirname $dominio $pass
echo "==========================================================================================================="

#GERANDO CERTIFICADO (CSR)
echo "GERANDO CERTIFICADO DE SOLICITAÇÃO DE ASSINATURA (CSR) ===================================================="
source $dirname/scripts/generate-csr-system-server.sh $dirname $dominio $pass
echo "==========================================================================================================="